export const environment = {
  ...
  uploadAssetUrl: 'https://api.synopsis.rozie.ai/r3/uploadAsset',
  listAssetsUrl: 'https://api.synopsis.rozie.ai/r3/listAssets',
  deleteAssetUrl: 'https://api.synopsis.rozie.ai/r3/deleteAsset',
